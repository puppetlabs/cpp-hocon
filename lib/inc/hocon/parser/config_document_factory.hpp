...
namespace hocon { namespace config_document_factory {
     ...
     */
    std::shared_ptr<config_document> parse_file(std::string input_file_path, shared_parse_options options);
     ...
     * @return the parsed configuration
     */
    std::shared_ptr<config_document> parse_string(std::string s, shared_parse_options options);

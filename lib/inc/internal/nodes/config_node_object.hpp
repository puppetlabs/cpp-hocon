...
namespace hocon {
    ...
    using shared_node_object = std::shared_ptr<config_node_object>;
    ...
    public:
        ...
        shared_node_object set_value_on_path(config_node_path desired_path, shared_node_value value,
                                                              config_syntax flavor = config_syntax::CONF);
        ...
        shared_node_object remove_value_on_path(std::string desired_path, config_syntax flavor);
